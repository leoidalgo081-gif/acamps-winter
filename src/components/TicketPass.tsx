...
import { Calendar, MapPin, Download, Copy, Check, Ticket, RefreshCw, User, ShieldCheck, CreditCard } from 'lucide-react';
      ...
      <div className="w-full max-w-sm mt-5 space-y-2 px-1">
        ...
        <div className="bg-[#254b8c] p-3 rounded-none border-2 border-[#2e5aa8] flex items-start gap-2 text-[10px] text-gray-400 mt-2">
          ...
          <p className="leading-normal">
            Sua reserva foi criada! Clique no botão verde acima para realizar o pagamento oficial no E-Inscrição e garantir sua vaga.
          </p>
        </div>
      </div>
    </div>
